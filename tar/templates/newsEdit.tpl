{include file="documentHeader"}
	<head>
		<title>{lang}bash.page.newsEdit.title{/lang} - {lang}{PAGE_TITLE}{/lang}</title>
		...
		<div id="main">
			<div class="mainHeadline">
				...
				<div class="headlineContainer">
					<h2>{lang}bash.page.newsEdit.title{/lang}</h2>
				</div>
			</div>
			...
			<form method="post" action="index.php?form=NewsEdit">
