...
<div class="mainHeadline">
	...
	<div class="headlineContainer">
		<h2>{lang}bash.acp.index{/lang}</h2>
	</div>
</div>
...
{if $this->user->getPermission('admin.user.canEditUser')}
	<form method="post" action="index.php?form=UserSearch">
		<fieldset>
			<legend>{lang}bash.acp.index.searchUsers{/lang}</legend>
...
<div class="tabMenu">
	<ul>
		{if $updates|count > 0}<li id="updates"><a onclick="tabMenu.showSubTabMenu('updates');"><span>{lang}bash.acp.index.updates{/lang}</span></a></li>{/if}
		{if $news|count > 0}<li id="news"><a onclick="tabMenu.showSubTabMenu('news');"><span>{lang}bash.acp.index.news{/lang}</span></a></li>{/if}
		<li id="system"><a onclick="tabMenu.showSubTabMenu('system');"><span>{lang}bash.acp.index.system{/lang}</span></a></li>
		<li id="stat"><a onclick="tabMenu.showSubTabMenu('stat');"><span>{lang}bash.acp.index.stat{/lang}</span></a></li>
		<li id="credits"><a onclick="tabMenu.showSubTabMenu('credits');"><span>{lang}bash.acp.index.credits{/lang}</span></a></li>
	...
	<form method="post" action="index.php?form=PackageUpdate">
		<div class="border tabMenuContent hidden" id="updates-content">
			<div class="container-1">
				<h3 class="subHeadline">{lang}bash.acp.index.updates{/lang}</h3>
				<p class="description">{lang}bash.acp.index.updates.description{/lang}</p>
				
				<ul>
					{foreach from=$updates item=update}
						<li{if $update.version.updateType == 'security'} class="formError"{/if}>
							{lang}bash.acp.index.updates.update{/lang}
							<input type="hidden" name="updates[{@$update.packageID}]" value="{$update.version.packageVersion}" />
						</li>
					{/foreach}
				</ul>
				
				<p><input type="submit" value="{lang}bash.acp.index.updates.startUpdate{/lang}" /></p>
				<input type="hidden" name="packageID" value="{@PACKAGE_ID}" />
				{@SID_INPUT_TAG}
			</div>
		</div>
...
{if $news|count > 0}
	<div class="border tabMenuContent hidden" id="news-content">
		<div class="container-1">
			<h3 class="subHeadline">{lang}bash.acp.index.news{/lang}</h3>
...
<div class="border tabMenuContent hidden" id="system-content">
	<div class="container-1">
		<h3 class="subHeadline">{lang}bash.acp.index.system{/lang}</h3>
		
		<fieldset>
			<legend>{lang}bash.acp.index.system.software{/lang}</legend>
		
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.bash.version{/lang}</p>
				<p class="formField">{PACKAGE_VERSION} (Bellatrix)</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.wcf.version{/lang}</p>
				<p class="formField">{WCF_VERSION}</p>
			</div>
		</fieldset>
		
		<fieldset>
			<legend>{lang}bash.acp.index.system.server{/lang}</legend>
		
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.os{/lang}</p>
				<p class="formField">{$os}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.webserver{/lang}</p>
				<p class="formField">{$webserver}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.php{/lang}</p>
				<p class="formField"><a href="index.php?page=PHPInfo&amp;packageID={@PACKAGE_ID}{@SID_ARG_2ND}">{PHP_VERSION}</a></p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.sql.type{/lang}</p>
				<p class="formField">{$sqlType} &quot;{$dbName}&quot;</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.sql.version{/lang}</p>
				<p class="formField">{$sqlVersion}</p>
			</div>
			<div class="formElement">
				<p class="formFieldLabel">{lang}bash.acp.index.system.cache{/lang}</p>
				<p class="formField">{$cacheSource}</p>
			</div>
			{if $load}
				<div class="formElement">
					<p class="formFieldLabel">{lang}bash.acp.index.system.load{/lang}</p>
...
<div class="border tabMenuContent hidden" id="stat-content">
	<div class="container-1">
		<h3 class="subHeadline">{lang}bash.acp.index.stat{/lang}</h3>
		
		<div class="formElement">
			<p class="formFieldLabel">{lang}bash.acp.index.stat.members{/lang}</p>
			<p class="formField">{#$members}</p>
		</div>
		<div class="formElement">
			<p class="formFieldLabel">{lang}bash.acp.index.stat.usersOnline{/lang}</p>
			<p class="formField">{#$usersOnline}</p>
		</div>
		<div class="formElement">
			<p class="formFieldLabel">{lang}bash.acp.index.stat.entries{/lang}</p>
			<p class="formField">{#$entries}</p>
		</div>
		<div class="formElement">
			<p class="formFieldLabel">{lang}bash.acp.index.stat.database.entries{/lang}</p>
			<p class="formField">{#$databaseEntries}</p>
		</div>
		<div class="formElement">
			<p class="formFieldLabel">{lang}bash.acp.index.stat.database.size{/lang}</p>
...
<div class="border tabMenuContent hidden" id="credits-content">
	<div class="container-1">
		<h3 class="subHeadline">{lang}bash.acp.index.credits{/lang}</h3>
		...
		<div class="formElement">
			<p class="formFieldLabel">{lang}bash.acp.index.credits.developer{/lang}</p>
			<p class="formField">Johannes Donath</p>
		</div>		
		<div class="formElement">
			<p class="formFieldLabel">{lang}bash.acp.index.credits.designer{/lang}</p>
			<p class="formField">Johannes Donath</p>
		</div>	
