...
class BASHCore extends WCF implements PageMenuContainer, UserCPMenuContainer, UserProfileMenuContainer {
	protected static $account;
	protected static $userLicences = array();
	...
	protected function initTPL() {
		...
		// check offline mode
		if (OFFLINE && !self::getUser()->getPermission('user.bash.canViewBASHOffline')) {
	...
	protected static function initPageMenu() {
		...
		if (PageMenu::getActiveMenuItem() == '') PageMenu::setActiveMenuItem('bash.header.menu.index');
	}
	...
	protected function initSession() {
		require_once(BASH_DIR.'lib/system/session/BASHSessionFactory.class.php');
		$factory = new BASHSessionFactory();
